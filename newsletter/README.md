...
The reusable generation prompt, the exact lens, depth, and format, is in [**PROMPT.md**](PROMPT.md). Paste it or let the skill run it, and every edition comes out the same quality.
